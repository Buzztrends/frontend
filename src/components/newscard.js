...
//   console.log(data);
  return (
    <div className='flex flex-col w-[30%] rounded-lg border border-black' onClick={()=>{toggleModal({data: data })}}>
        ...
        <Image alt="" className='rounded-t-lg' src='/images/card.png' width={1500} height={100} />
    ...
    : data.description}</div>
        <div className='flex justify-between text-xs font-normal leading-5 tracking-wide justify-self-end'>
