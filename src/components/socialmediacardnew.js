...
const Socialmediacardnew = ({title,trending,key}) => {
  ...
  return (
        <div className='flex flex-col w-1/5 border border-gray-100 shadow-sidd cursor-pointer gap-2 justify-between p-3' >
       <div className='text-sm font-medium leading-7 tracking-wide'>{title}</div>
