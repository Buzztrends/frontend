        ...
        <div className="flex">
            ...
            <div className=" w-4/5 ml-auto">
                ...
                <div className="p-5 mt-24 flex flex-col gap-11">
                    ...
                    {isModalOpen && (
                        <>
                            <div onClick={closeModal} className="fixed inset-0 bg-gray-800 bg-opacity-50"></div>
                            <div className="fixed inset-0 z-50 flex p-4 overflow-x-hidden overflow-y-auto max-h-full items-center justify-center">
