              ...
              <form action="" className="ml-6">
                <div className="mt-5">
                  ...
                  <div className="flex items-center space-x-2 w-10/12">
                    ...
                    />
                    <span
                      className={`select-none cursor-pointer inline-flex items-center space-x-1 px-5 py-2 mt-2 rounded-lg hover:bg-gray-200 font-medium ${
                        momentCustomization
                ...
                <div className="my-10">
                  <div
                    className={`flex item-center justify-between w-10/12 py-5 px-5 rounded-xl ${
                      contentFormVisible
                        ? "border"
                  ...
                  <div
                    className={`border border-solid border-primary-color rounded-lg shadow-primary w-10/12 h-auto px-8 mt-2 ${
                      contentFormVisible ? "block" : "hidden"
                    }`}
                  >
                    ...
                    <div className="my-10">
                      ...
                      <textarea
                        ...
                        id="similar content"
                        className="border border-solid border-primary-color rounded-lg shadow-primary block w-10/12 h-64 px-5 py-2 mt-2 font-medium overflow-y-auto"
                      />
                    </div>
