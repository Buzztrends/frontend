...
export default function Research() {
  ...
  return (
    <div>
      <button
        onClick={toggleModal}
        className="block text-white bg-linear-gradient hover:bg-blue-800 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
        type="button"
      >
        News-Card
      </button>
